package net.scalamusic.output.lilypond

import java.io._

import net.scalamusic.score._
import net.scalamusic.output.{ScoreRenderer, Format}

import scala.sys.process._
import net.scalamusic.score.{VoiceElement, Score}
...
object Lilypond extends ScoreRenderer {
  ...
  def write(score: Score, target: File, format: Format): Unit = {
    ...
    val tmpFile = File.createTempFile("net.scalamusic", ".ly")
  ...
  def show(score: Score, format: Format = Format.Pdf): Unit = {
    val file = File.createTempFile("net.scalamusic", "")
