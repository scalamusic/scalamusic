...
import net.scalamusic.score.Interval
import net.scalamusic.score.Interval._
...
object PositionScorer extends ChordScorer {
  ...
  override def apply(ch: ConnectionChord): Double = {
    ...
    def distance(i1: Int, i2: Int) = ch.notes(i1).pitch.toMidi - ch.notes(i2).pitch.toMidi
